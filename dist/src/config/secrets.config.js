...
exports.loadSecretsIntoEnv = void 0;
const secretManager_service_1 = require("../app/middlewares/secretManager.service");
...
const loadSecretsIntoEnv = async () => {
    ...
    const [dbRaw, firebaseRaw, smtpRaw] = await Promise.all([
        (0, secretManager_service_1.getSecret)(SECRET_DB),
        (0, secretManager_service_1.getSecret)(SECRET_FIREBASE),
        (0, secretManager_service_1.getSecret)(SECRET_SMTP),
    ]);
...
exports.loadSecretsIntoEnv = loadSecretsIntoEnv;
